...
G_xvz1_solver = optim.Adam(G_xvz2.parameters(), lr = lr, betas=ourBetas)
...
for epoch in range(args.epochs):
    for i, (view1, view2,view3, data1, data2, data3) in enumerate(train_loader):
        ...
        #          d_xvs_loss.data, d_x_loss.data, g_loss.data))
